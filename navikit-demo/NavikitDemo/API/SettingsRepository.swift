...
enum AnnotatedEventsType: String, CaseIterable, Codable {
    ...
    var annotatedEvent: MMKAnnotatedEvents {
        switch self {
        case .manoeuvres:
            return .manoeuvres
...
enum AnnotatedRoadEventsType: String, CaseIterable, Codable {
    ...
    var annotatedEvent: MMKAnnotatedRoadEvents {
        switch self {
        case .danger:
            return .danger
...
protocol SettingsRepository {
    ...
    // Vehicle options
    var vehicleType: CurrentValueSubject<MMKDrivingVehicleType, Never> { get }
    ...
    var roadEventsOnRoute: [MMKRoadEventsEventTag: CurrentValueSubject<Bool, Never>] { get }
    ...
    var annotationLanguage: CurrentValueSubject<MMKAnnotationLanguage, Never> { get }
